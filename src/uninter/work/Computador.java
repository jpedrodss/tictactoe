...
public class Computador {
	//Possui os métodos que controlam as jogadas da máquina.
	
	public static void vezDoComputador(char[][] tabuleiro) {
		Random rand = new Random();
		int movimentoComputador;
		while (true) {
			movimentoComputador = rand.nextInt(9) + 1;
			if (movimentoValido(tabuleiro, Integer.toString(movimentoComputador))) {
				break;
			}
		}
		System.out.println("O computador jogou" + movimentoComputador);
		posicaoMovimento(tabuleiro, Integer.toString(movimentoComputador), 'O');
	}
	...
	public static void ComputerEasy() {
	...
	public static void ComputerHigh() {
